...
public class HuskHulkEntity extends CreatureEntity implements IAnimatable
{
    ...
    private <E extends IAnimatable> PlayState predicate(AnimationEvent<E> event)
    {
        if (event.isMoving() == true) {
            ...
            event.getController().setAnimation(new AnimationBuilder().addAnimation("animation.husk_hulk.idle", true));
            return PlayState.CONTINUE;
        }
    }

    public HuskHulkEntity(EntityType<? extends CreatureEntity> type, World worldIn)
    {
        super(type, worldIn);
