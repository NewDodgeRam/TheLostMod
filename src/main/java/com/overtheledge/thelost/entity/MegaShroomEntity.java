...
public class MegaShroomEntity extends CreatureEntity implements IAnimatable {
    ...
    private <E extends IAnimatable> PlayState predicate(AnimationEvent<E> event)
    {
        ...
        //}
        //else {
        event.getController().setAnimation(new AnimationBuilder().addAnimation("animation.mega_shroom.idle", true));
        return PlayState.CONTINUE;
        //}
    }

    public MegaShroomEntity(EntityType<? extends CreatureEntity> type, World worldIn)
    {
        super(type, worldIn);
