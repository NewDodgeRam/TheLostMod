...
public class TaoTekiEntity extends CreatureEntity implements IAnimatable {
    ...
    private <E extends IAnimatable> PlayState predicate(AnimationEvent<E> event)
    {
        ...
        //}
        //else {
            event.getController().setAnimation(new AnimationBuilder().addAnimation("animation.tao_teki.idle", true));
            return PlayState.CONTINUE;
        //}
    }

    public TaoTekiEntity(EntityType<? extends CreatureEntity> type, World worldIn)
    {
        super(type, worldIn);
